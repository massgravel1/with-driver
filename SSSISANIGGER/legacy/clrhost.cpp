...
// NOTE(SSSISANIGGER): Compare class and method attributes we are looping with our predefined classes and methods
...
bool prepare_methods()
{
    ...
    // NOTE(SSSISANIGGER): returns zero on race-condition
